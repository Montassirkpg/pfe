...
class Rpgame extends StatefulWidget {
  @override
  _RpgameState createState() => _RpgameState();
}

class _RpgameState extends State<Rpgame> {
  @override
  Widget build(BuildContext context) {
    return WillPopScope(
      ...
      new Scaffold(
      body: StreamBuilder(
      stream: Firestore.instance.collection('products').where('category',isEqualTo: 'Role play').snapshots(),
