...
class Simgame extends StatefulWidget {
  @override
  _SimgameState createState() => _SimgameState();
}

class _SimgameState extends State<Simgame> {
  @override
  Widget build(BuildContext context) {
    return WillPopScope(
      ...
      child: 
        Scaffold(
      body: StreamBuilder(
      stream: Firestore.instance.collection('products').where('category',isEqualTo: 'Simulation').snapshots(),
