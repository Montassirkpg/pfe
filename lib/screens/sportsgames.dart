...
class Sportgame extends StatefulWidget {
  @override
  _SportgameState createState() => _SportgameState();
}

class _SportgameState extends State<Sportgame> {
  @override
  Widget build(BuildContext context) {
    return WillPopScope(
      ...
      child:  
       Scaffold(
      body: StreamBuilder(
      stream: Firestore.instance.collection('products').where('category',isEqualTo: 'Sports').snapshots(),
